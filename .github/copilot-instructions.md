# Instructions Copilot - Panini-CloudOrchestrator

📍 **CONTEXTE LOCAL :** Tu te trouves actuellement dans le sous-module `modules/orchestration/cloud`.
**Mission stricte :** Infra Cloud et K8s.

⚠️ **RÈGLES D'ANTI-DÉBORDEMENT :**
- Que de l'infrastructure pure (Bicep/Terraform).
